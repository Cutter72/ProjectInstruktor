...
public class LessonService {
    ...
    public List<Lesson> getPnLessons(int year, int month, int day) {
        ...
        return lessonRepository.findAllByStartTime(pnDayStart, pnDayEnd);
    }

    public List<Lesson> getWtLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(wtDayStart, wtDayEnd);
    }
    public List<Lesson> getSrLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(srDayStart, srDayEnd);
    }

    public List<Lesson> getCzLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(czDayStart, czDayEnd);
    }

    public List<Lesson> getPtLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(ptDayStart, ptDayEnd);
    }

    public List<Lesson> getSoLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(soDayStart, soDayEnd);
    }

    public List<Lesson> getNdLessons(int year, int month, int day) {
        LocalDateTime selectedDateTime = LocalDateTime.of(year, month, day, 0, 0, 0);
        ...
        return lessonRepository.findAllByStartTime(ndDayStart, ndDayEnd);
    }
